...
const Player = () => {
    const [volume, setVolume] = useState(0.9); // Default volume is 50%
    ...
    return (
        <div className='w-full grid md:grid-cols-4 grid-cols-2 absolute left-0 bottom-0 rounded-md px-2'>
            ...
            <div className="col-span-1 md:flex hidden items-center gap-x-3.5">
                <img src="./albums/album1.jpg" alt="" className="w-14 h-14 rounded-lg object-cover object-center p-0.5" />
                <div className="space-y-0.5">
                    <h6 className="text-sm text-neutral-200 font-semibold">Dancin</h6>
                    <p className="text-xs text-neutral-400 font-normal">Aaron Smith</p>
                </div>
